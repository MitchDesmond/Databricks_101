...
# add widgest
# update import data from csv section - this notebok and data tips
# run all cells and update save table
...
# MAGIC 
# MAGIC ### Setup
# MAGIC - This notebook requires Databricks Runtime 7.6+ for Machine Learning, which includes the latest MLFlow, along with other machine learning frameworks like sklearn, PyTorch, TensorFlow, XGBoost, etc. No need for you to install them.
...
# display the files in teh wine quality data set
